...
<head>
    ...
    <title>Asesor Legal Navarro Heredia</title>
    <!-- Favicon icon -->
		...
		<div class="chatbox">
			...
			<div class="custom-tab-1">
				<ul class="nav nav-tabs">
					...
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab" href="#alerts">Aleartas</a>
					</li>
					<li class="nav-item">
								...
								<ul class="contacts">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											...
											<div class="user_info">
												<span>Guzman Guzman</span>
												<p>Diana estaba hace 7 mins.</p>
											</div>
										</div>
									</li>
									<li class="dz-chat-user">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											...
											<div class="user_info">
												<span>Sergio Jacobo</span>
												<p>Sergio estaba hace 30 mins.</p>
											</div>
										</div>
									</li>
							...
							<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									...
									<div class="msg_cotainer">
										Hola, enviame los avances del reporte.
										<span class="msg_time">8:40 AM, Today</span>
									</div>
								</div>
								<div class="d-flex justify-content-end mb-4">
									<div class="msg_cotainer_send">
										Hola Oscar, las credenciales no son visibles
								...
								<div class="d-flex justify-content-start mb-4">
									...
									<div class="msg_cotainer">
										Entendido, no tardo en corregirlo
					...
					<div class="tab-pane fade" id="alerts" role="tabpanel">
						<div class="card mb-sm-3 mb-md-0 contacts_card">
							...
							<div class="card-body contacts_body p-0 dz-scroll" id="DZ_W_Contacts_Body1">
								<ul class="contacts">
									<li class="name-first-letter">SEVER ESTATUS</li>
									<li class="active">
										<div class="d-flex bd-highlight">
											<div class="img_cont primary">KK</div>
											<div class="user_info">
												<span>Cumpleaños de Jesus N</span>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown notification_dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
										...
										<ul class="timeline">
											...
											<li>
											 ...
											 <li>
												<div class="timeline-panel">
													...
													<div class="media-body">
														<h6 class="mb-1">Dr Aguilar envio una foto</h6>
														<small class="d-block">29 Julio 2023 - 02:26 PM</small>
													</div>
												</div>
											</li>
											<li>
											...
											<li>
												<div class="timeline-panel">
													...
													<div class="media-body">
														<h6 class="mb-1">Recordatorio : Horario de pruebas!</h6>
														<small class="d-block">29 Julio 2023 - 02:26 PM</small>
													</div>
												</div>
											</li>
                                    ...
                                    <a class="all-notification" href="#">Mostrar notificaciones <i class="ti-arrow-right"></i></a>
                                </div>
                            </li>
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
									<div class="header-info">
										<span>Hola, <strong>Oscar</strong></span>
									</div>
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="page-analytics.html">Analisis</a></li>
							<li><a href="page-review.html">Reseñas</a></li>
							<li><a href="page-order.html">Pedidos</a></li>
							<li><a href="page-order-list.html">Lista de Pedidos</a></li>
							<li><a href="page-general-customers.html">Clientes</a></li>
						</ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							...
							<span class="nav-text">Paguina</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="./page-register.html">Registro</a></li>
                            <li><a href="./page-login.html">iniciar Seccion</a></li>
                            ...
                            <li><a href="./page-lock-screen.html">Pantalla Bloquada</a></li>
                        </ul>
                    </li>
                </ul>
				...
				<div class="add-menu-sidebar">
					...
					<p>Organiza el menu de servicios</p>
					<a href="javascript:void(0);" class="btn btn-primary btn-block light">+ Añadir Servicio</a>
				</div>
				<div class="copyright">
					<p><strong>AsesorLegal - Admin Dashboard</strong> © 2023 All Rights Reserved</p>
			...
			<div class="container-fluid">
				<div class="form-head d-flex mb-3 align-items-start">
					<div class="mr-auto d-none d-lg-block">
						...
						<p class="mb-0">Bienvenido a Asesor Legal!</p>
					</div>
					...
					<div class="dropdown custom-dropdown">
						<div class="btn btn-sm btn-primary light d-flex align-items-center svg-btn" data-toggle="dropdown">
							...
							<div class="text-left ml-3">
								<span class="d-block fs-16">Periodo </span>
								<small class="d-block fs-13">4 Junio 2023 - 4 Julio 2023</small>
							</div>
							<i class="fa fa-angle-down scale5 ml-3"></i>
						</div>
						<div class="dropdown-menu dropdown-menu-right">
							<a class="dropdown-item" href="#">4 Junio 2023 - 4 Julio 2023</a>
							<a class="dropdown-item" href="#">5 julio 2023 - 4 Aug 2023</a>
						</div>
					</div>
				</div>
                <div class="row">
							...
							<div class="card-body p-4">
								<div class="media ai-icon">
									...
									<div class="media-body">
										...
										<p class="mb-0">Horas trabajas</p>
										<small>4% (30 días)</small>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card-body p-4">
								<div class="media ai-icon">
									...
									<div class="media-body">
										...
										<p class="mb-0">Total de Reservaciones</p>
										<small>4% (30 días)</small>
									</div>
								</div>
							</div>
							...
							<div class="card-body p-4">
								<div class="media ai-icon">
									...
									<div class="media-body">
										...
										<p class="mb-0">Total de Ordenes</p>
										<small>4% (30 días)</small>
									</div>
								</div>
							</div>
					...
					<div class="col-xl-6 col-xxl-6 col-lg-12 col-md-12">
						<div class="card">
							<div class="card-header border-0 pb-0 d-sm-flex d-block">
								<div>
									<h4 class="card-title mb-1">Sumas de ordenes</h4>
									<small class="mb-0">Control de gastos.</small>
								</div>
							...
							<div class="card-body orders-summary">
								<div class="d-flex order-manage p-3 align-items-center mb-4">
									...
									<h4 class="mb-0">Nuevas Pedidos <i class="fa fa-circle text-success ml-1 fs-15"></i></h4>
									<a href="javascript:void(0);" class="ml-auto text-primary font-w500">Pedidos <i class="ti-angle-right ml-1"></i></a>
								</div>
								<div class="row">
									<div class="col-sm-4 mb-4">
										<div class="border px-3 py-3 rounded-xl">
											<h2 class="fs-32 font-w600 counter">25</h2>
											<p class="fs-16 mb-0">En camino</p>
										</div>
									</div>
									<div class="col-sm-4 mb-4">
										<div class="border px-3 py-3 rounded-xl">
									...
									<div class="col-sm-4 mb-4">
										<div class="border px-3 py-3 rounded-xl">
											...
											<p class="fs-16 mb-0">Cancelados</p>
										</div>
									</div>
								</div>
									...
									<div class="row align-items-center mx-0">
										...
										<div class="col-xl-9 col-lg-8 col-xxl-8 col-sm-8 px-0">
											<div class="d-flex align-items-center mb-3">
												<p class="mb-0 fs-14 mr-2 col-4 px-0">Imunitario (24%)</p>
											...
											<div class="d-flex align-items-center  mb-3">
												<p class="mb-0 fs-14 mr-2 col-4 px-0">Pulso (41%)</p>
												<div class="progress mb-0" style="height:8px; width:100%;">
							...
							<div class="card-body revenue-chart px-3">
									<div class="d-flex align-items-end pr-3 pull-right revenue-chart-bar">
										<div class="d-flex align-items-end mr-4">
											...
											<div>
												<small class="text-dark fs-14">Ingresos</small>
						...
						<div id="user-activity" class="card">
							<div class="card-header border-0 pb-0 d-sm-flex d-block">
								<div>
									...
									<small class="mb-0">Rendimiento de clientes en efectividad de compras</small>
								</div>
								<div class="card-action card-tabs mt-3 mt-sm-0">
									<ul class="nav nav-tabs" role="tablist">
										<li class="nav-item">
